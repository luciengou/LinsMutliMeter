...
unsigned int Temp_Count,P_count;
		...
		while(TEMP)
	     ...
	     if(P_count > 0x7010){Temp_Count = 0;}	 //
	   	 else{ Temp_Count = ( 0x7010 - P_count)/19.4; //9.936 ;1760 2329 
	 	   if(Temp_Count > 121)
...
*/
   ...
   if(ADD_COD == 1 ) 
	 { Code_Value = Code_Value - (Code_Value/71); }	  //TC_Span_Value
   else
	 { Code_Value = Code_Value + (Code_Value/71);}
